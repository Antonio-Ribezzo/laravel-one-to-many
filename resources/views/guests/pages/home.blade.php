...
<div class='container d-flex justify-content-between align-items-start flex-wrap mt-5'>
    @foreach ($projects as $key=>$el)
        <div class="card p-3 mx-2 mb-5" style="width:calc(95% / 2);">
            ...
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-body-secondary"><span class="text-decoration-underline">Link</span>:<a href="{{$el->link}}" target="_blank" class="ms-1 card-link">Click here!</a></h6>
            </div>
        </div>
    @endforeach
</div>
